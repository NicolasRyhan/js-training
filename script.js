...
/*Aqui estou selecionando no html a transctions*/
const transactionsUl = document.querySelector('#transactions')
/*Aqui estou selecionando no html a money-plus*/
const incomeDisplay = document.querySelector('#money-plus')
/*Aqui estou selecionando no html a money-minus*/
const expenseDisplay = document.querySelector('#money-minus')
/*Aqui estou selecionando no html a balance*/
const balanceDisplay = document.querySelector('#balance')
/*Aqui estou selecionando no html a form*/
const form = document.querySelector('#form')
/*Aqui estou selecionando no html a text*/
const inputTransactionName = document.querySelector('#text')
/*Aqui estou selecionando no html a amount*/
